...
func initializeSpaces() {
	...
	board.Spaces = append(board.Spaces, &models.RailRoad{models.OwnableSpace{models.Space{Name: "Reading Railroad", Position: 5}, nil, false, 0, 0, 200}})
	...
	board.Spaces = append(board.Spaces, &models.RailRoad{models.OwnableSpace{models.Space{Name: "Pennsylvania Railroad", Position: 15}, nil, false, 0, 0, 200}})
	...
	board.Spaces = append(board.Spaces, &models.RailRoad{models.OwnableSpace{models.Space{Name: "B. & O. Railroad", Position: 25}, nil, false, 0, 0, 200}})
	...
	board.Spaces = append(board.Spaces, &models.RailRoad{models.OwnableSpace{models.Space{Name: "Short Line", Position: 35}, nil, false, 0, 0, 200}})
